...
#define SEG3_GPU_DVFS_FREQ1			(725000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(700000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(85000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(82500)		/* mV x 100 */
